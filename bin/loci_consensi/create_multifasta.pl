...
create_multifasta.pl

=head1 SYNOPSIS

This converts an ACE file to an aligned multi-FASTA file. It is also meant to store the FASTA file to the online file system, but the code is incomplete. 
...
my $input = 'loci2_out.ace';

my $output = '>loci2_out_multi.fasta';
